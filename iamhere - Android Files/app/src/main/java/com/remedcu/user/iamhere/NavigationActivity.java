...
public class NavigationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    double longit;
    Button send;
    private static final String LOGIN_URL = "http://wealthwrite.net/receive.php";
    private static final String LOGIN_URLS = "http://wealthwrite.net/clear.php";
...
//                    LatLng origin = MarkerPoints.get(0);
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, LOGIN_URL,
                                new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        if (response.equalsIgnoreCase("Error")) {
                                            ...
                                            String[] cord = response.split("&");
                                            latit = Double.parseDouble(cord[0]);
                                            longit = Double.parseDouble(cord[1]);
                                            Toast.makeText(getApplicationContext(), response, Toast.LENGTH_SHORT).show();
                                            LatLng toreach = new LatLng(latit,longit);
                                            mMap.addMarker(new MarkerOptions().position(toreach).title("iamhere!"));
                                        }
                                    }
                                },
                                new Response.ErrorListener() {
                            ...
                            protected Map<String,String> getParams(){
                                ...
                                params.put(LANG, String.valueOf(mLastLocation.getLongitude()));
                                params.put(KEY_MYNAME,KEY_MYUSERNAME);
                                return params;
                            }
                        };
